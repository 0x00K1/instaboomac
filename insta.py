...
victim_username = input("   [ THE VICTIM ] - - > ")
TPALL = '''
    +----------------------------+--------+
    |        Reason              | Numara |
    +----------------------------+--------+
...
class InstaScript:
    ...
    def login(self):
        ...
        try:
            ...
            print("       [x]Something wrong from the server or internet")
            exit()
    ...
    def victim_profile(self):
        ...
        try:
            ...
            print("       [x]The user||email or password is wrong")
            exit()
            ...
            for _ in range(0, self.number):
                ...
                try:
                    ...
                    if STFILSPAM == 5:
                        ...
                        print(" X> The account is disable to report try again or change to another ac.")
                        break
